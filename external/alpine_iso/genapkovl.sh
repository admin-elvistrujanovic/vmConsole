...
+root/.bash_profile
+root/.bashrc
+root/guides/Advanced_Bash_Scripting_Guide.txt
+root/guides/Bash_Guide_For_Beginners.txt
+root/guides/Introduction_To_Linux.txt
+root/guides/The_Linux_System_Administrators_Guide.txt
+root/README.txt
EOF
...
tar -c -C "$tmp" etc root | gzip -9n > defaults.apkovl.tar.gz
